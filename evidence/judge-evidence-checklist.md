...
| --- | --- | --- |
| Copilot Chat agent | Ready; Microsoft 365 Copilot Chat screenshots captured | `apps/copilot-agent/package/manifest.json`, `apps/copilot-agent/package/manifest.azure.json`, `evidence/copilot/signal-foundry-copilot-mcp-run-functions-20260608-1459.zip`, `evidence/screenshots/copilot-agent-invocation-asteria.png`, `evidence/copilot/copilot-evidence-capture-runbook.md` |
...
| Gate | Evidence Asset |
| --- | --- |
| Copilot surface | `evidence/copilot/signal-foundry-copilot-mcp-run-functions-20260608-1459.zip`, `evidence/screenshots/copilot-agent-invocation-asteria.png` |
