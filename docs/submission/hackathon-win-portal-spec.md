...
- Ensure current package is `evidence/copilot/signal-foundry-copilot-v101-guided-chat-20260612.zip`.
...
`/Users/mattgraves/Development/hackathon-enterprise/evidence/copilot/signal-foundry-copilot-v101-guided-chat-20260612.zip`

Windows upload path:

`C:\Users\demouser\Downloads\SignalFoundry\signal-foundry-copilot-v101-guided-chat-20260612.zip`
...
1. Confirm package hash on Windows:
   ...
   ```powershell
   Get-FileHash -Algorithm SHA256 -Path "C:\Users\demouser\Downloads\SignalFoundry\signal-foundry-copilot-v101-guided-chat-20260612.zip"
   ```

2. Confirm package contents:

   ```powershell
   tar -tf "C:\Users\demouser\Downloads\SignalFoundry\signal-foundry-copilot-v101-guided-chat-20260612.zip"
   ```
...
3. Confirm manifest version is newer than prior upload:
   ...
   ```powershell
   Expand-Archive -Path "C:\Users\demouser\Downloads\SignalFoundry\signal-foundry-copilot-v101-guided-chat-20260612.zip" -DestinationPath "$env:TEMP\sf-v017" -Force
...
```powershell
atk install --file-path "C:\Users\demouser\Downloads\SignalFoundry\signal-foundry-copilot-v101-guided-chat-20260612.zip"
```

If installing for shared scope is enabled for the tenant:

```powershell
atk install --file-path "C:\Users\demouser\Downloads\SignalFoundry\signal-foundry-copilot-v101-guided-chat-20260612.zip" --scope Shared
```
...
6. Choose `signal-foundry-copilot-v101-guided-chat-20260612.zip`.
7. Add the app.
