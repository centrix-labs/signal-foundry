...
| 3 | **Demo video** | ✅ Met | `evidence/videos/signal-foundry-demo-narrated-1080p.mp4`, `…-side-by-side-1080p.mp4`, `signal-foundry-live-demo.webm`. SUBMISSION.md references the demo. |
